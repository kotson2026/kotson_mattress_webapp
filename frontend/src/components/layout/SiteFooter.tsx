    ...
    <footer className="mt-20 bg-brand-charcoal text-brand-sand">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-4">
        <div className="md:col-span-2">
          <LogoMark light />
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-brand-sand/70" data-testid="footer-about">
            {blocks?.footer_about ?? "KOTSON NATURALS PRIVATE LIMITED, trading as KOTSON MATTRESS."}
          </p>
        </div>
        <div>
          <h3 className="text-sm font-semibold uppercase tracking-widest text-brand-leaf">Shop</h3>
        ...
        <div>
          <h3 className="text-sm font-semibold uppercase tracking-widest text-brand-leaf">Company</h3>
          <ul className="mt-4 space-y-2 text-sm">
